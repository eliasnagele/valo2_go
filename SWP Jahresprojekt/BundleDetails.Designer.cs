namespace SWP_Jahresprojekt
{
    partial class BundleDetails
    {
        ...
        private PictureBox pb_BundleDetails;
        private Label lb_BundleDetailsName;
        private Label lb_BundleDetailsPrice;
        private Label lb_BundleDetailsRarity;
        private Label lb_BundleDetailsDate;
        private Label lb_BundleDetailsVariants;
        private TextBox tB_BundleDetailsDate;
        private TextBox tB_BundleDetailsVariants;
        private TextBox tB_BundleDetailsName;
        private TextBox tB_BundleDetailsPrice;
        private TextBox tB_BundleDetailsRarity;
